...
[Compositor](https://github.com/Chaoses-Ib/Compositor) 是一款开源且功能齐全、完全免费且开源的图像编辑器。原开发者日常工作需要进行大量的影像合成和后期处理，因此 Compositor 的设计也围绕着这个工作流程展开——它提供了创建像素级完美最终图像所需的所有工具。界面是纯粹的 SwiftUI，汉化版则是国内开发者提供的。但原版和汉化版的二进制把最低系统卡在 **macOS 26.5**——而我的机器是 macOS 15.8，双击图标直接被系统拒之门外。
